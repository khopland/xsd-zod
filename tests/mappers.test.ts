...
import {
  ...
  applyFacets,
  mapEnumeration,
} from "../src/mappers/primitive";
import {
  mapComplexType,
  mapElement,
  mapAttribute,
} from "../src/mappers/complex";
...
describe("Enumeration Mapper", () => {
  it("should map simple type with enumeration", () => {
    ...
    expect(result.zodValidator).toBe(
