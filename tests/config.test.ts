...
describe('Config Validation', () => {
  ...
  it('should throw error for invalid naming convention', () => {
    ...
    expect(() => validateOptions(options)).toThrow('Invalid naming convention: invalid');
  });

  it('should accept all valid naming conventions', () => {
    const namingConventions: Array<'camel' | 'pascal' | 'original' | 'kebab'> = ['camel', 'pascal', 'original', 'kebab'];
